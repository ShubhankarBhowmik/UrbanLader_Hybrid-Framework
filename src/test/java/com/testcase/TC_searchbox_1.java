...
public class TC_searchbox_1 extends BaseClass{
	@Test(dataProvider="LoginData")
	public void SearchTest(String place) throws IOException{
	...
	{
		ReadData config= new ReadData("D:\\maven testing\\UrbanhybridProject2\\src\\test\\java\\com\\testData\\searchData.xlsx");
